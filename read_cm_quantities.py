...
class ReadCMQuantities:
    ...
    def subscribe_to_quantities(self):
        ...
        for traffic_object_id in self.traffic_object_ids:
            ...
            current_traffic_object.pitch = Quantity("Traffic." + traffic_object_id + ".rx", Quantity.FLOAT)
            current_traffic_object.roll = Quantity("Traffic." + traffic_object_id + ".ry", Quantity.FLOAT)
